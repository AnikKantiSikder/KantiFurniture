...
<head>
  ...
  <title>Kantifurniture dashboard</title>
...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="{{ route('logout') }}"
              ...
              style="background-color: #ff0000">Log out</a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
      ...
      <!-- <span class="brand-text font-weight-light">Kanti soft.</span>
 -->
    </a>
    ...
    {{-- Including sidebar menu starts here --}}
    @include('Backend.Layouts.sidebar_menu')
    {{-- Including sidebar menu ends here --}}
...
@yield('content')
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2020 <a href="#">KantiSoft.</a></strong>
    All rights reserved.
    <div class="float-right d-none d-sm-inline-block">
      <b>Design and developed by KantiSoftLtd.</b>
    </div>
  </footer>
