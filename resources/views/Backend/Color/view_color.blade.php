            ...
            <div class="card">
              <div class="card-header">
                <h3>Color list
                  ...
                  <a class="btn btn-success btn-sm float-right" href="{{ route('colors.add') }}">
              ...
              <div class="card-body">
                <table id="datatable" class="table table-bordered table-striped" style="text-align: center;">
                      ...
                      @php
                        $countColor= App\Model\ProductColor::where('color_id',$color->id)->count();
                      @endphp
                      <tr>
                        <td> {{$key+1}} </td>

                        <td style="text-align: justify;">{{$color->name}}</td>
