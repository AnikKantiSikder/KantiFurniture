            ...
            <div class="card">
              <div class="card-header">
                <h3>
                  ...
                  <a class="btn btn-success btn-sm float-right" href="{{ route('brands.view') }}">
              ...
              <div class="card-body">
                ...
                <form method="POST"
                   action="
                    @if (isset($editBrandData))
                      {{ route('brands.update',$editBrandData->id) }}
                    @else
                      {{ route('brands.store') }}
                ...
                <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <input type="text" name="name" value="{{@$editBrandData->name}}" class="form-control" placeholder="Write brand name">
