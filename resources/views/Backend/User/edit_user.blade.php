          ...
          <section class="col-lg-12">
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('users.update', $allData->id) }}" id="myForm">
                  @csrf
                    ...
                    <div class="form-row">
                      ...
                      <div class="col">
                        ...
                        <input type="text" name="name" value="{{$allData->name}}" class="form-control" placeholder="User name"  >
                       ...
                       <div class="col">
                        ...
                        <input class="form-control" type="email" value="{{$allData->email}}" name="email" placeholder="Email address">
                        <font style="color: red;">
